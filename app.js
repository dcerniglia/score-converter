...
function convertToAct(satScore) {
    let actScore = 0;
    if (satScore >= 1300) {
        actDisplay.value = 30;
    } else {
...
function convertToSat(actScore) {
    let satScore = 0;
    if (actScore >= 25) {
        satDisplay.value = 1250;
    } else {
        satDisplay.value = 1130;
    }
}
...
satDisplay = document.getElementById("satScore");
actDisplay = document.getElementById("actScore");
